...
namespace loginTutorial
{
    class dbcontrol
    {
        SqlConnection cn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\dbtest.mdf;Integrated Security=True");
        SqlCommand cm;
        ...
        public void query(string name)
        {
            ...
            {
                exception = "Employee ID already in use, please Enter a unique ID.";
            }
            finally
            {
